...
The recommended way to create a new BBAChain dapp is using [create-solana-dapp](https://github.com/solana-developers/create-solana-dapp). All frontend templates include wallet-adapter support. 