...
import { createSignInMessage } from '@bbachain/wallet-standard-util';
import type { Transaction, TransactionVersion, VersionedTransaction } from '@bbachain/web3.js';
...
export class UnsafeBurnerWalletAdapter extends BaseSignInMessageSignerWalletAdapter {
    ...
    url = 'https://github.com/bbachain/wallet-adapter#usage';
    icon =
    ...
    constructor() {
        ...
        console.warn(
            'Your application is presently configured to use the `UnsafeBurnerWalletAdapter`. ' +
                ...
                'https://github.com/bbachain/wallet-adapter#usage for an example.'
        );
    }
    ...
    async signIn(input: BBAChainSignInInput = {}): Promise<BBAChainSignInOutput> {
